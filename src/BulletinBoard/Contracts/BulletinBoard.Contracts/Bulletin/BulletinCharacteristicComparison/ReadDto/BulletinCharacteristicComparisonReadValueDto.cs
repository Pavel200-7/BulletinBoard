...
/// <summary>
/// Характеристика объявления с ее значением в виде вложенных ДТО
/// </summary>
public class BulletinCharacteristicComparisonReadValueDto
{
    /// <summary>
    ...
    /// Характеристика
    /// </summary>
    public BulletinCharacteristicDto Characteristic { get; set; }


     /// <summary>
     /// Значение характеристики.
     /// </summary>
    public BulletinCharacteristicValueDto CharacteristicValue { get; set; }
}
