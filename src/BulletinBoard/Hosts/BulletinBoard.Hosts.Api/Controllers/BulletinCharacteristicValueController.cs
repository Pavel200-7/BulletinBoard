...
public class BulletinCharacteristicValueController : ControllerBase
{
    ...
    /// Пример запроса:
    ///
    ///    GET /BulletinCharacteristicValue/01992529-1ec8-766f-a03d-a7ac4f0996b9
    ///
    /// </remarks>
    ...
    /// Пример запроса:
    ///
    ///    Post /BulletinCharacteristicValue
    ///    {
    ...
    /// Пример запроса:
    ///
    ///    Put /BulletinCharacteristicValue
    ///    {
    ///         "value": "Значени хорактеристики"
    ///    }
    ///
    ...
    /// Пример запроса:
    ///
    ///    Delete /BulletinCharacteristicValue/3fa85f64-5717-4562-b3fc-2c963f66afa6
    ///
    /// </remarks>
    /// <param name="id">id значения характеристики.</param>
    /// <param name="cancellationToken">Токен отмены.</param>
    ...
    /// Пример запроса:
    ///
    ///    Get /BulletinCharacteristicValue/byCharacteristic/3fa85f64-5717-4562-b3fc-2c963f66afa6
    ///
    /// </remarks>
